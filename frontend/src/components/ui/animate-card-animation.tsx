...
const cardData = {
  1: {
    ...
    description: "48-dimension financial health analysis",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop",
  },
  2: {
    title: "Tax Optimizer",
    description: "Old vs. New regime AI comparison",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=2072&auto=format&fit=crop",
  },
  3: {
    title: "FIRE Planner",
    description: "Monte Carlo retirement stress-testing",
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center pt-2">
      ...
      <div className="relative z-10 -mt-px flex w-full items-center justify-center border-t border-border py-4">
        <div onMouseEnter={handleAnimate}>
          <ButtonWithIcon label="Animate" onClick={handleAnimate} />
        </div>
      </div>
    </div>
  )
